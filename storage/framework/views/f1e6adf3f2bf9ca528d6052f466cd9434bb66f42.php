                                ...
                                <div class="well">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                            <?php echo e($travel->fromLoc); ?>-<?php echo e($travel->toLoc); ?>

                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <h3><a href="/travels/<?php echo e($travel->id); ?>"><?php echo e($travel->fromLoc); ?>-<?php echo e($travel->toLoc); ?></a></h3>
                                            <small> Owner <?php echo e($travel->pkgOwner); ?> Reciever <?php echo e($travel->pkgReciever); ?></small>
                                        </div>
                                        <div class="col-md-2 col-sm-2">
                                                <p><?php if($travel->status == "waiting"): ?> <div class=""> Waiting</div> <?php endif; ?></p>
                            ...
                            <?php if(count($dels) > 0): ?>
                                ...
                                <div class="well">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                                <p><?php if($del->status == "requested"): ?> <div class=""> Waiting</div> <?php endif; ?></p>
