                        ...
                        <div class="card-body">
                            ...
                            @if(count($travels) > 0)
                                @foreach($travels as $travel)
                                    <div class="well">
                                    <a href="travels/{{$travel->id}}">User  {{$travel->travellerId}} from {{$travel->fromLoc}} to {{$travel->toLoc}} by {{$travel->travelling_by}} on {{$travel->trvlDate}}</a> 
                                    </div>
                                    <hr>    
                                @endforeach
                    ...
                    <div class="card-header">Delivery</div>
                        <div class="card-body">
                            <hr>
                                ...
                                @foreach($dels as $del)
                                    <div class="well">
                                        <a href="delivery/{{$del->id}}">Request for delivering a {{$del->pkgType}} package from {{$del->fromLoc}} to {{$del->toLoc}} for {{$del->pkgCredit}} Credits</a> 
                                    </div>
                                    <hr>    
                                @endforeach
                                @else
