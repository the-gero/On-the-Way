                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('travels.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fromLoc" type="text" class="form-control{{ $errors->has('fromLoc') ? ' is-invalid' : '' }}" name="fromLoc" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="toLoc" type="text" class="form-control{{ $errors->has('toLoc') ? ' is-invalid' : '' }}" name="toLoc" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="trvlDate" type="date"  class="form-control{{ $errors->has('trvlDate') ? ' is-invalid' : '' }}" name="trvlDate" required>
